...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
  ...
  <div>
    <h2>Education</h2>
    <ul>
      <li><strong>BSc in Computer Science (Honors)</strong>, 2027<br>University of Wisconsin-Madison</li>
      <li><strong>BSc in Computer Science and Mathematics</strong>, 2024<br>Northeastern University</li>
    </ul>
  </div>
